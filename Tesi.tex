...
%\include{./2-Introduzione/Introduzione}
%
%\clearemptydoublepage

\include{./0-Introduzione/Introduzione}

\clearemptydoublepage

\include{./1-Modelli/Modelli}
\clearemptydoublepage

\include{./2-MasterEquation/MasterEquation}

\clearemptydoublepage

\include{./3-Upscaling/Upscaling}

\clearemptydoublepage

\include{./4-Applicazioni/Applicazioni}

\clearemptydoublepage


\include{./5-Conclusioni/Conclusioni}

%\backmatter

\clearemptydoublepage

%\include{./5-Ringraziamenti/Ringraziamenti} % non obbligatorio
%\clearemptydoublepage

\include{./7-Bibliografia/Bibliografia}

\appendix

\clearemptydoublepage

%\include{./7-Appendice/Appendice} % non obbligatorio
%\clearemptydoublepage
