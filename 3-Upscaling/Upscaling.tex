...
Notiamo che P(\emph{n}|1) deve essere definita solamente per $\emph{n}\ge1$ poiché per poter osservare una data specie questa deve essere popolata da almeno un individuo.\newline
