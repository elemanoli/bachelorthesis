...
Definiamo $\emph{p}^*=\emph{n}/N$ la frazione di campionamento e $^*$ il numero di specie osservate nel sotto campione, $S^*=\sum_{\emph{k>1}} \emph{f}_\emph{k}$.\\
...
La disuguaglianza di Cauchy-Schwarz porta a:
